...
- Corrects the namespace used to expose the config provider within the package;
  it now correctly reads `Mezzio\Helper\ConfigProvider`.
...
- [zendframework/zend-expressive-helpers#31](https://github.com/zendframework/zend-expressive-helpers/pull/32) Check
